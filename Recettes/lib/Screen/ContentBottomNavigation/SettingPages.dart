// ignore_for_file: file_names, prefer_const_constructors, prefer_const_literals_to_create_immutables, unused_element, dead_code, non_constant_identifier_names
      ...
      body: Container(
        ...
        child: ListView(
          children: [
            ...
            builNotificationOption(
                "Mode Claire/Dark", valNotify1, OnChangeFunction1),
            builNotificationOption(
                "Activer Compte", valNotify2, OnChangeFunction2),
            ...
            Center(
              child: OutlinedButton(
                ...
                onPressed: () async {
                  await context.read<Authentification>().deconnexion();
                },
                child: Text(
                  "Deconnexion",
                  style: TextStyle(
