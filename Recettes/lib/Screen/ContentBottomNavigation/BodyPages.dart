          ...
          dinnerList = List.generate(
            ...
            (index) {
              return Meals(
                  ...
                  imageMeals: reponse["meals"][index]["strMealThumb"]
                      .replaceAll(RegExp(r'\\'), ''),
                  ...
                  child: Stack(clipBehavior: Clip.none, children: [
                    widget.user!.photoURL != null
                        ...
                        : Center(
                            child: Text(
                              widget.user!.email![0]
                                  .toUpperCase(), // premiere lettre de l'email
                              style: TextStyle(
                    ...
                    // si la photo != null afficher la photo sinon afficher l'image( a toi de recuper l'image du gars)
                    // et gère aussi si l'email est trop long (il y aurat un overflow)
